...
export const healthRecipeMappingApi = {
  ...
  update: async (id: any, payload: any) => {
    const { data } = await http.put<any>(`/mapping-health-recipes/${id}/`, payload);
    return data;
  },

  patch: async (id: any, payload: any) => {
    const { data } = await http.patch<any>(`/mapping-health-recipes/${id}/`, payload);
    return data;
  },
  ...
  approve: async (id: any, payload: any) => {
    const { data } = await http.post<any>(`/mapping-health-recipes/${id}/approve/`, payload);
    return data;
  },
